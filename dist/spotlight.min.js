 ...
 */
(function(){"use strict";(()=>{const E=(h,t=document)=>Array.from(t.querySelectorAll(h)),c=(h,t={},e=[])=>{const s=document.createElement(h);return Object.entries(t).forEach(([i,n])=>{i==="style"?Object.assign(s.style,n):i.startsWith("on")&&typeof n=="function"?s.addEventListener(i.slice(2),n):i==="dataset"?Object.entries(n).forEach(([o,a])=>s.dataset[o]=a):s.setAttribute(i,n)}),e.forEach(i=>typeof i=="string"?s.appendChild(document.createTextNode(i)):s.appendChild(i)),s},T=`
  ...
  `;class A{constructor(){this.collections=[],this.overlay=null,this.state={open:!1,collectionIndex:0,itemIndex:0,scale:1,baseScale:1,translateX:0,translateY:0,fullscreen:!1},this._rafId=null,this._renderActive=!1,this.renderState={scale:1,translateX:0,translateY:0},this._uiHideTimer=null,this._uiHideDelay=1500,this._wheelSwipeAccum=0,this._wheelSwipeTimer=null,this._wheelMode=null,this._swipeActive=!1,this._swipeDirection=0,this._pendingSlideDir=0,this.touchStart=null,this._dragPointerId=null,this._dragLast={x:0,y:0},this._isPinching=!1,this.pointers=new Map,this._init()}_init(){this._injectStyles(),this._scanCollections(),this._createOverlay(),this.liveRegion=c("div",{"aria-live":"polite",style:{position:"absolute",width:"1px",height:"1px",padding:"0",margin:"-1px",overflow:"hidden",clip:"rect(0,0,0,0)",whiteSpace:"nowrap",border:"0"}}),this.nodes.shell.appendChild(this.liveRegion),this._bindGlobalListeners()}_scanCollections(){const t=[];E("article").forEach(e=>{const s=E("img",e);s.length&&t.push({type:"article",el:e,imgs:s})}),E(".gallery").forEach(e=>{if(!t.some(s=>s.el===e)){const s=E("img",e);t.push({type:"gallery",el:e,imgs:s})}}),t.forEach((e,s)=>{const i=[];e.imgs.forEach((n,o)=>{const a=n.dataset.src||n.getAttribute("src")||n.currentSrc||null;if(!a)return;const r=n.closest("figure"),l=r?r.querySelector("figcaption"):null,d=l?l.textContent.trim():(n.getAttribute("data-caption")||n.getAttribute("alt")||"").trim();i.push({src:a,el:n,caption:d}),n.dataset.spotlightCollection=String(this.collections.length),n.dataset.spotlightIndex=String(i.length-1),n.style.cursor="zoom-in"}),i.length&&this.collections.push({id:`spot-${this._randId()}`,container:e.el,items:i})})}_randId(){return Math.random().toString(36).slice(2,9)}_createOverlay(){const t=c("div",{id:"spot-overlay","aria-hidden":"true",tabindex:"-1"}),e=c("div",{id:"spot-bg"}),s=c("div",{id:"spot-shell",role:"dialog","aria-modal":"true"}),i=c("div",{id:"spot-stage",class:"spot-stage"}),n=c("button",{id:"spot-prev",class:"spot-nav","aria-label":"Previous image","data-dir":"-1"});n.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="icon icon-tabler icons-tabler-outline icon-tabler-chevron-compact-left" viewBox="0 0 24 24"><path stroke="none" d="M0 0h24v24H0z"/><path d="m13 20-3-8 3-8"/></svg>';const o=c("div",{id:"spot-canvas",class:"spot-canvas"}),a=c("div",{id:"spot-transform",class:"spot-transform"}),r=c("img",{id:"spot-img",draggable:"false"});a.appendChild(r),o.appendChild(a);const l=c("button",{id:"spot-next",class:"spot-nav","aria-label":"Next image","data-dir":"1"});l.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="icon icon-tabler icons-tabler-outline icon-tabler-chevron-compact-right" viewBox="0 0 24 24"><path stroke="none" d="M0 0h24v24H0z"/><path d="m11 4 3 8-3 8"/></svg>',i.appendChild(n),i.appendChild(o),i.appendChild(l);const d=c("div",{id:"spot-ui",class:"spot-ui spot-ui-visible"}),p=c("div",{id:"spot-topbar",class:"spot-topbar"}),_=c("div",{id:"spot-counter",class:"spot-counter"}),u=c("div",{class:"spot-controls"}),m=c("button",{id:"spot-zoom-out",class:"spot-btn","aria-label":"Zoom out"});m.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="icon icon-tabler icons-tabler-outline icon-tabler-zoom-out" viewBox="0 0 24 24"><path stroke="none" d="M0 0h24v24H0z"/><path d="M3 10a7 7 0 1 0 14 0 7 7 0 1 0-14 0m4 0h6m8 11-6-6"/></svg>';const y=c("button",{id:"spot-zoom-display",class:"spot-btn","aria-label":"Reset zoom"},["100%"]),f=c("button",{id:"spot-zoom-in",class:"spot-btn","aria-label":"Zoom in"});f.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="icon icon-tabler icons-tabler-outline icon-tabler-zoom-in" viewBox="0 0 24 24"><path stroke="none" d="M0 0h24v24H0z"/><path d="M3 10a7 7 0 1 0 14 0 7 7 0 1 0-14 0m4 0h6m-3-3v6m11 8-6-6"/></svg>';const S=c("button",{id:"spot-fullscreen",class:"spot-btn","aria-label":"Toggle fullscreen"}),g=c("button",{id:"spot-close",class:"spot-btn","aria-label":"Close"});g.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="icon icon-tabler icons-tabler-outline icon-tabler-x" viewBox="0 0 24 24"><path stroke="none" d="M0 0h24v24H0z"/><path d="M18 6 6 18M6 6l12 12"/></svg>',u.appendChild(m),u.appendChild(y),u.appendChild(f),u.appendChild(S),u.appendChild(g),p.appendChild(_),p.appendChild(u);const x=c("div",{id:"spot-caption",class:"spot-caption"});d.appendChild(p),d.appendChild(x),s.appendChild(i),s.appendChild(d),t.appendChild(e),t.appendChild(s),document.body.appendChild(t),this.overlay=t,this.nodes={overlay:t,bg:e,shell:s,ui:d,closeBtn:g,zoomIn:f,zoomOut:m,zoomDisplay:y,fullscreenBtn:S,prevBtn:n,nextBtn:l,canvas:o,transform:a,imgNode:r,counter:_,caption:x},this._pointerOverUi=!1,this._pointerOverUiCount=0;const C=Array.from(t.querySelectorAll(".spot-btn")),I=[this.nodes.prevBtn,this.nodes.nextBtn,this.nodes.caption,p,...C].filter(Boolean),O=()=>{this._pointerOverUiCount=(this._pointerOverUiCount||0)+1,this._pointerOverUi=!0,this._showUiImmediate()},H=()=>{this._pointerOverUiCount=Math.max(0,(this._pointerOverUiCount||0)-1),this._pointerOverUiCount===0&&(this._pointerOverUi=!1,this._scheduleUiHide())};I.forEach(v=>{v.addEventListener("pointerenter",O),v.addEventListener("pointerleave",H)}),this.nodes.closeBtn.addEventListener("click",()=>this.close()),this.nodes.bg.addEventListener("click",()=>this.close()),this.nodes.prevBtn.addEventListener("click",()=>this.prev()),this.nodes.nextBtn.addEventListener("click",()=>this.next()),this.nodes.zoomIn.addEventListener("click",()=>this._zoomBy(1.2)),this.nodes.zoomOut.addEventListener("click",()=>this._zoomBy(1/1.2)),this.nodes.zoomDisplay.addEventListener("click",()=>this._resetZoom()),this.nodes.fullscreenBtn.addEventListener("click",()=>this._toggleFullscreen()),t.addEventListener("pointermove",()=>this._handleUserActivity()),t.addEventListener("pointerdown",()=>this._handleUserActivity()),t.addEventListener("touchstart",()=>this._handleUserActivity(),{passive:!0}),this._updateFullscreenButton(),t.addEventListener("wheel",v=>{this.state.open&&this._isPointerOverStage(v)&&v.preventDefault()},{passive:!1})}_isPointerOverStage(t){const e=this.nodes.canvas.getBoundingClientRect();return t.clientX>=e.left&&t.clientX<=e.right&&t.clientY>=e.top&&t.clientY<=e.bottom}_bindGlobalListeners(){window.addEventListener("keydown",s=>this._handleKeydown(s)),this.nodes.canvas.addEventListener("wheel",s=>{if(!this.state.open)return;this._handleUserActivity(),this._detectWheelMode(s)==="swipe"?(s.preventDefault(),this._handleSwipeWheel(s.deltaX)):(s.preventDefault(),this._handleWheelZoom(s)),this._scheduleWheelGestureReset()},{passive:!1}),this.nodes.imgNode.addEventListener("pointerdown",s=>{if(this.state.open&&(this._handleUserActivity(),!!s.isPrimary)){this._dragPointerId=s.pointerId,this._dragLast.x=s.clientX,this._dragLast.y=s.clientY,this._dragStart={x:s.clientX,y:s.clientY},this._isVerticalSwipe=!1;try{this.nodes.imgNode.setPointerCapture(s.pointerId)}catch{}}}),window.addEventListener("pointermove",s=>{if(this._dragPointerId!==s.pointerId)return;if(this._handleUserActivity(),this._isPinching){this._dragPointerId=null;return}if(!this._isVerticalSwipe&&this._dragStart&&s.pointerType==="touch"){const o=s.clientY-this._dragStart.y,a=s.clientX-this._dragStart.x;Math.abs(this.state.scale-(this.state.baseScale||1))<.1&&o>0&&Math.abs(o)>Math.abs(a)&&o>20&&(this._isVerticalSwipe=!0,this._swipeIntent=!0)}if(this._isVerticalSwipe){const o=s.clientY-this._dragLast.y;this.state.translateY+=o,this._dragLast.x=s.clientX,this._dragLast.y=s.clientY,this._startRenderLoop();return}if(s.pointerType==="touch"&&Math.abs(this.state.scale-(this.state.baseScale||1))<.1)return;const i=s.clientX-this._dragLast.x,n=s.clientY-this._dragLast.y;this._dragLast.x=s.clientX,this._dragLast.y=s.clientY,this.state.translateX+=i,this.state.translateY+=n,this._constrainAndSync(),this._startRenderLoop()}),window.addEventListener("pointerup",s=>{if(this._dragPointerId===s.pointerId){this._isVerticalSwipe&&(s.clientY-this._dragStart.y>150?this.close():(this.state.translateY=0,this._constrainAndSync(),this._startRenderLoop()),this._isVerticalSwipe=!1);try{this.nodes.imgNode.releasePointerCapture(s.pointerId)}catch{}this._dragPointerId=null}}),this.touchStart=null,this.nodes.canvas.addEventListener("touchstart",s=>{this.state.open&&(this._handleUserActivity(),s.touches.length===1?this.touchStart={x:s.touches[0].clientX,y:s.touches[0].clientY,t:Date.now()}:this.touchStart=null)},{passive:!0}),this.nodes.canvas.addEventListener("touchend",s=>this._handleTouchEnd(s),{passive:!0}),this._bindPinch(),new ResizeObserver(()=>{this.state.open&&(this._fitImageToViewport(),this._applyTransform({immediate:!0}))}).observe(this.nodes.canvas),document.addEventListener("fullscreenchange",()=>this._syncFullscreenState());let e=1;this.nodes.canvas.addEventListener("gesturestart",s=>{this.state.open&&(s.preventDefault(),!(this.pointers.size>0)&&(e=1,this._isPinching=!0))},{passive:!1}),this.nodes.canvas.addEventListener("gesturechange",s=>{if(!this.state.open||(s.preventDefault(),this.pointers.size>0))return;const i=s.scale/e;if(e=s.scale,i!==1){const n=1+(i-1)*1;this._zoomAtPoint(n,s.clientX,s.clientY)}},{passive:!1}),this.nodes.canvas.addEventListener("gestureend",()=>{this.pointers.size>0||(this._isPinching=!1)},{passive:!1})}_handleSwipeWheel(t){this._handleUserActivity();const e=45,s=this.state.baseScale||1;if(!(Math.abs(this.state.scale-s)>Math.max(.8,s*.5))){if(this._swipeActive){const i=t===0?0:t>0?1:-1,n=Math.abs(t)<1.5;if(i&&i!==this._swipeDirection||n)this._endWheelGesture();else return}this._wheelSwipeAccum+=t,this._wheelSwipeAccum>e?this._commitSwipeNavigation(1):this._wheelSwipeAccum<-e&&this._commitSwipeNavigation(-1)}}_commitSwipeNavigation(t){const e=Date.now();if(e-(this._lastSwipeTime||0)<500){this._wheelSwipeAccum=0;return}this._lastSwipeTime=e,this._swipeActive=!0,this._swipeDirection=t,this._wheelSwipeAccum=0,t<0?this.prev():t>0&&this.next()}_detectWheelMode(t){if(this._wheelMode)return this._wheelMode;if(t.ctrlKey)return this._wheelMode="zoom",this._wheelMode;const e=Math.abs(t.deltaX),s=Math.abs(t.deltaY),i=this.state.baseScale||1,n=Math.abs(this.state.scale-i)<=Math.max(.8,i*.5);if(e<1&&s<1)return"zoom";const o=e>s*.65&&e-s>1||s<10&&e>10;if(n&&o)this._wheelMode="swipe";else if(s>e)this._wheelMode="zoom";else return"zoom";return this._wheelMode}_handleWheelZoom(t){if(this._isPinching)return;if(t.ctrlKey){const s=-t.deltaY,n=.01*1,o=1+s*n;this._zoomAtPoint(o,t.clientX,t.clientY);return}Math.abs(this.state.scale-(this.state.baseScale||1))<.1&&Math.abs(t.deltaY)>Math.abs(t.deltaX)&&Math.abs(t.deltaY)>1&&(this._isVerticalSwipe=!0,this._swipeIntent=!0,this.state.translateY+=t.deltaY,this.state.translateY<0&&(this.state.translateY=0),this._startRenderLoop())}_scheduleWheelGestureReset(){clearTimeout(this._wheelSwipeTimer),this._wheelSwipeTimer=setTimeout(()=>this._endWheelGesture(),140)}_endWheelGesture(){this._wheelSwipeTimer&&(clearTimeout(this._wheelSwipeTimer),this._wheelSwipeTimer=null),this._isVerticalSwipe&&(this.state.translateY>150?this.close():(this.state.translateY=0,this._constrainAndSync(),this._startRenderLoop()),this._isVerticalSwipe=!1),this._wheelSwipeAccum=0,this._swipeActive=!1,this._wheelMode=null,this._swipeDirection=0}_handleUserActivity(){this.state.open&&(this._showUiImmediate(),this._scheduleUiHide())}_scheduleUiHide(){clearTimeout(this._uiHideTimer),this._uiHideTimer=setTimeout(()=>{this._pointerOverUi?this._scheduleUiHide():this._hideUi()},this._uiHideDelay)}_showUiImmediate(){this.nodes?.ui&&(this.nodes.ui.classList.add("spot-ui-visible"),this.nodes.ui.classList.remove("spot-ui-hidden"),this.overlay&&this.overlay.classList.remove("spot-nav-hidden"))}_hideUi(){this.nodes?.ui&&(this.nodes.ui.classList.add("spot-ui-hidden"),this.nodes.ui.classList.remove("spot-ui-visible"),this.overlay&&this.overlay.classList.add("spot-nav-hidden"))}_toggleFullscreen(){this._handleUserActivity(),this.state.fullscreen?this._exitFullscreen():this._enterFullscreen()}_enterFullscreen(){const t=this.overlay;if(!(!t||document.fullscreenElement===t)){if(t.requestFullscreen){const e=t.requestFullscreen();e&&typeof e.catch=="function"&&e.catch(()=>{})}this._syncFullscreenState()}}_exitFullscreen(){if(document.fullscreenElement&&document.exitFullscreen){const t=document.exitFullscreen();t&&typeof t.catch=="function"&&t.catch(()=>{})}this._syncFullscreenState()}_syncFullscreenState(){const t=document.fullscreenElement===this.overlay;this.state.fullscreen=!!t,this._updateFullscreenButton()}_updateFullscreenButton(){const t=this.nodes?.fullscreenBtn;t&&(t.innerHTML=this.state.fullscreen?L:T,t.setAttribute("aria-label",this.state.fullscreen?"Exit fullscreen":"Enter fullscreen"),t.setAttribute("aria-pressed",String(this.state.fullscreen)))}_animateSlide(t,e){this._handleUserActivity(),this._pendingSlideDir=t||0,typeof e=="function"&&e()}_playSlideIn(t){const e=this.nodes?.imgNode;if(!e)return;const s=t||0;e.style.transition="none",s?(e.style.transform=`translateX(${s*60}px) scale(0.96)`,e.style.opacity="0"):(e.style.transform="translateX(0) scale(1)",e.style.opacity="1"),requestAnimationFrame(()=>{e.style.transition="transform 650ms cubic-bezier(0.3, 1, 0.3, 1), opacity 400ms ease",e.style.transform="translateX(0) scale(1)",e.style.opacity="1";const i=()=>{e.style.transition="",e.style.transform="",e.removeEventListener("transitionend",i)};e.addEventListener("transitionend",i,{once:!0})})}_bindPinch(){let t=0;const e=n=>{if(this.state.open&&(this._handleUserActivity(),this._swipeIntent=!1,this.pointers.set(n.pointerId,n),this.pointers.size===2)){this._isPinching=!0;const[o,a]=Array.from(this.pointers.values());t=Math.hypot(a.clientX-o.clientX,a.clientY-o.clientY)}},s=n=>{if(this.pointers.has(n.pointerId)){if(!this.state.open){this.pointers.clear(),this._isPinching=!1;return}if(this._handleUserActivity(),this.pointers.set(n.pointerId,n),this.pointers.size===2){const[o,a]=Array.from(this.pointers.values()),r=Math.hypot(a.clientX-o.clientX,a.clientY-o.clientY);if(t>0){const l=r/t;if(t=r,l!==1){const d=n.pointerType==="touch"?1.1:1,p=1+(l-1)*d,_=(o.clientX+a.clientX)*.5,u=(o.clientY+a.clientY)*.5;this._zoomAtPoint(p,_,u)}}}}},i=n=>{this.pointers.delete(n.pointerId),this.pointers.size<2&&(this._isPinching=!1,t=0)};this.nodes.canvas.addEventListener("pointerdown",e),window.addEventListener("pointermove",s),window.addEventListener("pointerup",i),window.addEventListener("pointercancel",i)}openCollection(t,e=0){this.collections[t]&&(this.state.open=!0,this.state.collectionIndex=t,this.state.itemIndex=e,this._handleUserActivity(),this._showOverlay(),this._loadItem())}_showOverlay(){this.overlay.style.display="block",this._lastFocused=document.activeElement,requestAnimationFrame(()=>{this.overlay.classList.add("spot-open"),this.overlay.setAttribute("aria-hidden","false"),document.documentElement.style.overflow="hidden",this._showUiImmediate(),this._scheduleUiHide(),this.nodes.shell.focus()})}close(){this.state.open&&(this.overlay.classList.remove("spot-open"),this.overlay.setAttribute("aria-hidden","true"),document.documentElement.style.overflow="",this.state.open=!1,this.state.fullscreen=!1,this._exitFullscreen(),this._updateFullscreenButton(),clearTimeout(this._uiHideTimer),clearTimeout(this._wheelSwipeTimer),this._wheelSwipeAccum=0,this._wheelMode=null,this._swipeActive=!1,this._swipeDirection=0,this._pendingSlideDir=0,this._hideUi(),setTimeout(()=>{this.state.open||(this.overlay.style.display="none"),this._lastFocused&&this._lastFocused.focus()},220))}prev(){const t=this.collections[this.state.collectionIndex];t&&(this.state.itemIndex=(this.state.itemIndex-1+t.items.length)%t.items.length,this._animateSlide(-1,()=>this._loadItem()))}next(){const t=this.collections[this.state.collectionIndex];t&&(this.state.itemIndex=(this.state.itemIndex+1)%t.items.length,this._animateSlide(1,()=>this._loadItem()))}_loadItem(){const t=this.collections[this.state.collectionIndex];if(!t)return;const e=t.items[this.state.itemIndex];if(!e)return;const s=this._pendingSlideDir||0;this._pendingSlideDir=0,this._resetRenderState(),this.nodes.imgNode.style.opacity="0",this.nodes.imgNode.src="",this.nodes.counter.textContent=`${this.state.itemIndex+1} / ${t.items.length}`,this._updateCaption(e.caption),this.liveRegion&&(this.liveRegion.textContent=`Image ${this.state.itemIndex+1} of ${t.items.length}${e.caption?": "+e.caption:""}`);const i=this.nodes.imgNode;i.onload=null,i.onerror=null,i.style.opacity="0",i.src="",i.onload=()=>{requestAnimationFrame(()=>{this._fitImageToViewport(),this._applyTransform({immediate:!0}),this._playSlideIn(s)})},i.onerror=()=>{i.src="",this._updateCaption("Failed to load image"),i.style.opacity="1"},i.src=e.src,/\.svg($|\?)/i.test(e.src)?i.classList.add("spot-svg"):i.classList.remove("spot-svg"),i.complete&&i.naturalWidth&&i.onload?.()}_updateCaption(t){if(!this.nodes||!this.nodes.caption)return;const e=(t||"").trim();e?(this.nodes.caption.textContent=e,this.nodes.caption.classList.remove("spot-caption-empty"),this.nodes.caption.style.display=""):(this.nodes.caption.textContent="",this.nodes.caption.classList.add("spot-caption-empty"),this.nodes.caption.style.display="none")}_resetRenderState(){this.state.scale=1,this.state.baseScale=1,this.state.translateX=0,this.state.translateY=0,this.renderState.scale=1,this.renderState.translateX=0,this.renderState.translateY=0,this._renderActive=!1,this.nodes.bg&&(this.nodes.bg.style.opacity=""),this.nodes.ui&&(this.nodes.ui.style.opacity=""),this.nodes.prevBtn&&(this.nodes.prevBtn.style.opacity=""),this.nodes.nextBtn&&(this.nodes.nextBtn.style.opacity=""),this.nodes.imgNode&&(this.nodes.imgNode.style.opacity=""),this._rafId&&(cancelAnimationFrame(this._rafId),this._rafId=null)}_startRenderLoop(){this._rafId||(this._renderActive=!0,this._lastRenderTime=Date.now(),this._renderLoop())}_renderLoop(){if(!this._renderActive||!this.state.open){this._rafId=null;return}const t=Date.now(),i=Math.min(t-(this._lastRenderTime||t),60)/1e3;this._lastRenderTime=t;const{scale:n,translateX:o,translateY:a}=this.state,r=this.renderState,l=1-Math.exp(-15*i);if(r.scale+=(n-r.scale)*l,r.translateX+=(o-r.translateX)*l,r.translateY+=(a-r.translateY)*l,this._checkConvergence(n,o,a,r),this.nodes.transform){this.nodes.transform.style.transition="none",this.nodes.transform.style.transform=`translate(${r.translateX}px, ${r.translateY}px) scale(${r.scale})`,this._updateZoomDisplay(r.scale),this._updateSwipeAnimation(r.translateY);const d=this.nodes.imgNode;d.style.cursor=Math.abs(r.scale-(this.state.baseScale||1))>.02||Math.abs(r.translateX)>1||Math.abs(r.translateY)>1?"grab":"zoom-out"}this._renderActive?this._rafId=requestAnimationFrame(()=>this._renderLoop()):this._rafId=null}_updateSwipeAnimation(t){const e=Math.abs(this.state.scale-(this.state.baseScale||1))<.1,s=[this.nodes.bg,this.nodes.ui,this.nodes.prevBtn,this.nodes.nextBtn,this.nodes.imgNode];if(t>0&&this.state.open&&e&&this._swipeIntent){const o=1-Math.min(1,Math.abs(t)/225);s.forEach(a=>{a&&(a.style.opacity=String(o))})}else s.forEach(i=>{i&&(i.style.opacity="")})}_checkConvergence(t,e,s,i){Math.abs(t-i.scale)<.001&&Math.abs(e-i.translateX)<.1&&Math.abs(s-i.translateY)<.1&&(i.scale=t,i.translateX=e,i.translateY=s,this._renderActive=!1,Math.abs(s)<1&&(this._swipeIntent=!1))}_fitImageToViewport(){const t=this.nodes?.imgNode;if(!t)return;const e=Math.max(window.innerWidth,1),s=Math.max(window.innerHeight,1),i=t.naturalWidth||t.width||t.clientWidth,n=t.naturalHeight||t.height||t.clientHeight;if(!i||!n)return;const o=e/i,a=s/n,r=e>=s;let l=1;if(r){const d=i<=e,p=n<=s;d||p?l=1:l=a,l=Math.min(l,1)}else l=Math.min(o,a);l=Math.min(8,Math.max(.05,l)),this.state.baseScale=l,this.state.scale=l,this.state.translateX=0,this.state.translateY=0,this.renderState.scale=l,this.renderState.translateX=0,this.renderState.translateY=0}_applyTransform(t={}){const e=t.immediate||!this.state.open;if(!this.nodes||!this.nodes.transform)return;const{scale:s,translateX:i,translateY:n}=this.state,o=this.nodes.transform;e?o.style.transition="none":o.style.transition="",o.style.transform=`translate(${i}px, ${n}px) scale(${s})`,this._updateZoomDisplay(s);const a=this.nodes.imgNode;a.style.cursor=Math.abs(s-(this.state.baseScale||1))>.02||Math.abs(i)>1||Math.abs(n)>1?"grab":"zoom-out"}_updateZoomDisplay(t){if(!this.nodes||!this.nodes.zoomDisplay)return;const e=Math.round((t||1)*100);this.nodes.zoomDisplay.textContent=`${e}%`,this.nodes.zoomDisplay.title=`Reset zoom (${e}%)`}_zoomBy(t){this._handleUserActivity(),this.state.scale=Math.min(8,Math.max(.2,this.state.scale*t)),this._startRenderLoop()}_resetZoom(){this._handleUserActivity(),this.state.scale=this.state.baseScale||1,this.state.translateX=0,this.state.translateY=0,this._startRenderLoop()}_constrainAndSync(){const{naturalWidth:t,naturalHeight:e}=this.nodes.imgNode,{clientWidth:s,clientHeight:i}=this.nodes.canvas,n=t*this.state.scale,o=e*this.state.scale,a=.05,r=s*.5+n*(.5-a),l=i*.5+o*(.5-a);this.state.translateX=Math.min(r,Math.max(-r,this.state.translateX)),this.state.translateY=Math.min(l,Math.max(-l,this.state.translateY))}_zoomAtPoint(t,e,s){this._handleUserActivity(),this._swipeIntent=!1;const i=(this.nodes.transform||this.nodes.imgNode).getBoundingClientRect(),n=e-i.left,o=s-i.top,a=n/i.width,r=o/i.height,l=this.state.scale,d=Math.min(8,Math.max(.2,l*t)),{clientWidth:p,clientHeight:_}=this.nodes.canvas,{naturalWidth:u,naturalHeight:m}=this.nodes.imgNode,y=u*d,f=m*d,S=e-p*.5-y*(a-.5),g=s-_*.5-f*(r-.5);this.state.translateX=S,this.state.translateY=g,this.state.scale=d,this._constrainAndSync(),this._startRenderLoop()}attachImage(t,e,s){t.dataset.spotlightCollection=String(e),t.dataset.spotlightIndex=String(s),t.addEventListener("click",i=>{i.preventDefault(),this.openCollection(e,s)})}_injectStyles(){if(document.getElementById("spotlight-styles"))return;const t=`:root{--spot-bg:rgba(6,6,8,1);--spot-ui-bg:rgba(20,20,24,0.78);--spot-ui-fg:rgba(255,255,255,0.95);--spot-muted:rgba(255,255,255,0.74);--spot-btn-bg:rgba(255,255,255,0.08);--spot-btn-border:rgba(255,255,255,0.1);--spot-shadow:0 10px 40px rgba(0,0,0,0.45);--spot-anim:300ms cubic-bezier(.22,.9,.35,1);--spot-font:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif}@media (prefers-color-scheme:light){:root{--spot-bg:rgba(250,250,252,1);--spot-ui-bg:rgba(255,255,255,0.8);--spot-ui-fg:rgba(17,17,20,0.92);--spot-muted:rgba(17,17,20,0.7);--spot-btn-bg:rgba(0,0,0,0.05);--spot-btn-border:rgba(0,0,0,0.1);--spot-shadow:0 2px 80px rgba(0,0,0,0.15)}#spot-overlay .spot-nav{background:rgba(255,255,255,.92);border-color:rgba(0,0,0,.06);box-shadow:0 6px 18px rgba(10,10,10,.06)}#spot-overlay .spot-nav:hover{background:rgba(245,245,245,.98)}}#spot-overlay{display:none;position:fixed;inset:0;z-index:2147483646;font-family:var(--spot-font);-webkit-font-smoothing:antialiased;opacity:0;transition:opacity var(--spot-anim);touch-action:none}#spot-overlay,#spot-overlay *{-webkit-user-select:none;user-select:none}#spot-overlay.spot-open{pointer-events:auto;opacity:1}#spot-bg,.spot-nav svg{transition:opacity var(--spot-anim)}#spot-bg,#spot-shell{position:fixed;inset:0;opacity:0}#spot-bg{background:var(--spot-bg)}#spot-shell{pointer-events:none;transform:scale(.996);transition:opacity var(--spot-anim),transform var(--spot-anim)}#spot-overlay.spot-open #spot-shell{opacity:1;transform:scale(1)}#spot-overlay.spot-open #spot-bg,.spot-controls .spot-btn:hover,.spot-nav:hover svg{opacity:1}#spot-canvas,#spot-stage{inset:0;display:flex;align-items:center;justify-content:center}#spot-stage{position:fixed;pointer-events:none;z-index:2147483645}#spot-canvas{position:absolute;overflow:hidden;pointer-events:auto}#spot-transform{will-change:transform;touch-action:none;transform-origin:center center;cursor:grab;transition:transform var(--spot-anim)}#spot-transform img{display:block;width:auto;height:auto;max-width:none;max-height:none;object-fit:contain;user-select:none;-webkit-user-drag:none;pointer-events:auto;transition:opacity 180ms ease}#spot-transform img.spot-svg{width:100%;height:auto;max-width:100vw;max-height:100vh}.spot-caption,.spot-nav,.spot-topbar{pointer-events:auto;color:var(--spot-ui-fg);box-shadow:var(--spot-shadow);backdrop-filter:blur(0)}.spot-nav{position:absolute;top:50%;transform:translateY(-50%);width:50px;height:50px;border-radius:50%;background:rgba(0,0,0,.35);border:1px solid rgba(255,255,255,.12);display:flex;align-items:center;justify-content:center;font-size:0;cursor:pointer;opacity:1;transition:background var(--spot-anim),transform var(--spot-anim),opacity var(--spot-anim),backdrop-filter var(--spot-anim);z-index:2147483650}#spot-overlay.spot-open .spot-nav{backdrop-filter:blur(6px)}.spot-nav svg{width:30px;height:30px;opacity:.5}.spot-nav:hover{background:rgba(0,0,0,.45)}.spot-nav[data-dir="-1"]{left:22px;--nav-offset:-40px}.spot-nav[data-dir="1"]{right:22px;--nav-offset:40px}#spot-ui{position:fixed;inset:0;pointer-events:none;display:flex;flex-direction:column;justify-content:space-between;gap:20px;z-index:2147483647}.spot-caption,.spot-topbar{background:var(--spot-ui-bg);transition:backdrop-filter var(--spot-anim)}#spot-overlay.spot-open .spot-caption,#spot-overlay.spot-open .spot-topbar{backdrop-filter:blur(18px)}.spot-controls,.spot-topbar{display:flex;align-items:center}.spot-topbar{gap:18px;height:50px}.spot-controls{margin-left:auto;gap:10px}.spot-controls svg{width:21px;height:21px}.spot-controls .spot-btn{opacity:.5;transition:opacity var(--spot-anim),background 150ms ease;will-change:opacity}.spot-btn,.spot-counter{height:50px;color:var(--spot-ui-fg);display:flex;justify-content:center;font-weight:600}.spot-counter{font-size:15px;letter-spacing:.08em;opacity:.5;min-width:10ch;max-width:12ch;padding:15px;box-sizing:border-box;align-items:flex-end;white-space:nowrap;font-variant-numeric:tabular-nums;-webkit-font-feature-settings:"tnum"1;font-feature-settings:"tnum"1}.spot-btn{width:50px;border-radius:6px;border:0;background:0 0;align-items:center;font-size:16px;cursor:pointer;transition:background 150ms ease}.spot-btn:active{transform:none}#spot-caption{padding:14px 18px;font-size:21px;line-height:1.45;color:var(--spot-muted)}#spot-caption.spot-caption-empty{opacity:0;pointer-events:none}#spot-overlay.spot-nav-hidden .spot-nav{opacity:0;pointer-events:none;transform:translateY(-50%) translateX(var(--nav-offset))}#spot-ui .spot-caption,#spot-ui .spot-topbar{transition:opacity var(--spot-anim),transform var(--spot-anim);will-change:opacity,transform}#spot-ui.spot-ui-hidden .spot-topbar{opacity:0;transform:translateY(-18px);pointer-events:none}#spot-ui.spot-ui-hidden .spot-caption{opacity:0;transform:translateY(18px);pointer-events:none}#spot-ui.spot-ui-visible .spot-caption,#spot-ui.spot-ui-visible .spot-topbar{opacity:1;transform:translateY(0)}@media (max-width:600px){#spot-ui{flex-direction:column-reverse}#spot-fullscreen{display:none}.spot-topbar{gap:10px;height:75px}.spot-controls svg{width:25px;height:25px}#spot-caption{font-size:16px}.spot-nav{display:none}.spot-nav[data-dir="-1"]{left:10px;--nav-offset:-20px}.spot-nav[data-dir="1"]{right:10px;--nav-offset:20px}}@media (prefers-reduced-motion:reduce){:root{--spot-anim:0s}#spot-transform{transition:none}}`,e=c("style",{id:"spotlight-styles",type:"text/css"});e.appendChild(document.createTextNode(t)),document.head.appendChild(e)}_handleKeydown(t){if(!this.state.open)return;this._handleUserActivity();const e=t.code||"",s=t.key||"",i=String(s).toLowerCase();if(e==="Escape"||s==="Escape"||s==="Esc"){this.close();return}this._handleNavigation(e,s,i)||this._handleZoom(e,s)||(this._isResetZoomKey(e,s)?this._resetZoom():(e==="KeyF"||i==="f")&&this._toggleFullscreen())}_handleNavigation(t,e,s){return this._isNextKey(t,e,s)?(this.next(),!0):this._isPrevKey(t,e,s)?(this.prev(),!0):!1}_handleZoom(t,e){return this._isZoomInKey(t,e)?(this._zoomBy(1.2),!0):this._isZoomOutKey(t,e)?(this._zoomBy(1/1.2),!0):!1}_isNextKey(t,e,s){return t==="ArrowRight"||t==="KeyL"||e==="ArrowRight"||s==="l"||e==="Right"}_isPrevKey(t,e,s){return t==="ArrowLeft"||t==="KeyH"||e==="ArrowLeft"||s==="h"||e==="Left"}_isZoomInKey(t,e){return t==="Equal"||t==="NumpadAdd"||e==="+"||e==="="}_isZoomOutKey(t,e){return t==="Minus"||t==="NumpadSubtract"||e==="-"||e==="_"}_isResetZoomKey(t,e){return t==="Digit0"||t==="Numpad0"||e==="0"||e===")"}_handleTouchEnd(t){if(!this.state.open||!this.touchStart)return;this._handleUserActivity();const e=t.changedTouches&&t.changedTouches[0]&&t.changedTouches[0].clientX||0,s=t.changedTouches&&t.changedTouches[0]&&t.changedTouches[0].clientY||0,i=e-this.touchStart.x,n=s-this.touchStart.y,o=Date.now()-this.touchStart.t;this.touchStart=null,this._isValidSwipe(i,n,o)&&(i<0?this.next():this.prev())}_isValidSwipe(t,e,s){const i=Math.abs(t),n=Math.abs(e);return i>n&&i>20&&s<500&&Math.abs(this.state.scale-(this.state.baseScale||1))<.25}}function b(){if(window.__spotlight_instance)return window.__spotlight_instance;const h=new A;return window.__spotlight_instance=h,h}const w=b;window.addEventListener("click",h=>{const t=h.target.closest("img");if(!t||!t.closest("article, .gallery"))return;h.preventDefault();const s=b(),i=parseInt(t.dataset.spotlightCollection||"0",10),n=parseInt(t.dataset.spotlightIndex||"0",10);s.openCollection(i,n)}),window.Spotlight={get instance(){return window.__spotlight_instance||null},open:(h=0,t=0)=>{window.__spotlight_instance||w(),window.__spotlight_instance.openCollection(h,t)},rescan:()=>{const h=window.__spotlight_instance||w();try{h.overlay&&h.overlay.parentNode&&h.overlay.parentNode.removeChild(h.overlay)}catch{}return delete window.__spotlight_instance,w()}}})()})();
